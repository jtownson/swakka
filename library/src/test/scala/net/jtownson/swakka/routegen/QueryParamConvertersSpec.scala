...
class QueryParamConvertersSpec extends FlatSpec with ConverterTest{
  ...
  it should "pass enumerated string query parameters iff the request provides a valid enum value" in {
    ...
    converterTest[String, QueryParameter[String]](Get("http://localhost?qp=NoNoNo"), qp, NotFound)
  }

  it should "pass enumerated optional string query parameters iff the request provides a valid enum value" in {
    ...
    converterTest[Option[String], QueryParameter[Option[String]]](Get("http://localhost?qp=NoNoNo"), oqp, NotFound)
  }

  it should "pass enumerated boolean query parameters iff the request provides a valid enum value" in {
    ...
    converterTest[Boolean, QueryParameter[Boolean]](Get("http://localhost?qp=true"), qp, NotFound)
  }

  it should "pass enumerated optional boolean query parameters iff the request provides a valid enum value" in {
    ...
    converterTest[Option[Boolean], QueryParameter[Option[Boolean]]](Get("http://localhost?qp=true"), qp, NotFound)
  }

  it should "pass enumerated int query parameters iff the request provides a valid enum value" in {
    val qp = QueryParameter[Int]('qp, None, None, Some(Seq(1, 2, 3)))
    converterTest[Int, QueryParameter[Int]](Get("http://localhost?qp=2"), qp, OK)
    converterTest[Int, QueryParameter[Int]](Get("http://localhost?qp=4"), qp, NotFound)
  }

  it should "pass enumerated optional int query parameters iff the request provides a valid enum value" in {
    ...
    converterTest[Option[Int], QueryParameter[Option[Int]]](Get("http://localhost?qp=4"), qp, NotFound)
  }

  it should "pass enumerated long query parameters iff the request provides a valid enum value" in {
    val qp = QueryParameter[Long]('qp, enum = Some(Seq(1, 2, 3)))
    converterTest[Long, QueryParameter[Long]](Get("http://localhost?qp=2"), qp, OK)
    converterTest[Long, QueryParameter[Long]](Get("http://localhost?qp=4"), qp, NotFound)
  }

  it should "pass enumerated optional long query parameters iff the request provides a valid enum value" in {
    ...
    converterTest[Option[Long], QueryParameter[Option[Long]]](Get("http://localhost?qp=4"), qp, NotFound)
  }

  it should "pass enumerated float query parameters iff the request provides a valid enum value" in {
    ...
    converterTest[Float, QueryParameter[Float]](Get("http://localhost?qp=4"), qp, NotFound)
  }

  it should "pass enumerated optional float query parameters iff the request provides a valid enum value" in {
    ...
    converterTest[Option[Float], QueryParameter[Option[Float]]](Get("http://localhost?qp=4"), qp, NotFound)
  }

  it should "pass enumerated double query parameters iff the request provides a valid enum value" in {
    ...
    converterTest[Double, QueryParameter[Double]](Get("http://localhost?qp=4"), qp, NotFound)
  }

  it should "pass enumerated optional double query parameters iff the request provides a valid enum value" in {
    ...
    converterTest[Option[Double], QueryParameter[Option[Double]]](Get("http://localhost?qp=4"), qp, NotFound)
  }
}
