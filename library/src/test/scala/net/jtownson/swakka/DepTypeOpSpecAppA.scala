...
// Investigate scala compiler problem

class DepTypeOpSpecAppA extends FlatSpec {
  ...
  trait Invoker[I] {
    type O
    def apply(f: I => O, i: I): O
  }

  object Invoker {
    type Aux[I, OO] = Invoker[I] {type O = OO}

    implicit def invoker[I]()
  }
